  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <div style={{ width: 28, height: 28, borderRadius: 8, background: "linear-gradient(135deg, #0D9488, #0F766E)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      ...
      <div className="flex items-center gap-2">
        ...
        {role === "MANAGER" && (
          <span style={{ fontSize: 11, fontWeight: 600, padding: "2px 8px", borderRadius: 20, background: "rgba(14,116,144,0.3)", color: "#67e8f9", border: "1px solid rgba(14,116,144,0.4)" }}>Verwaltung</span>
        )}
        {role === "CLEANER" && (
